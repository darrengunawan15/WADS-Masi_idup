                            ...
                            <div className="flex-shrink-0 bg-white px-6 py-4 border-t">
                                <form onSubmit={handleSendMessage} className="flex items-center space-x-4">
                                    <input
                                        ...
                                        style={activeTicket.status === 'resolved' ? { backgroundColor: '#f3f4f6', color: '#a1a1aa', cursor: 'not-allowed' } : {}}
                                    />
                                    <button
                                        type="submit"
                                        ...
                                        title="Send Message"
                                        disabled={activeTicket.status === 'resolved'}
                                        style={activeTicket.status === 'resolved' ? { backgroundColor: '#e5e7eb', color: '#a1a1aa', cursor: 'not-allowed' } : {}}
                                    >
