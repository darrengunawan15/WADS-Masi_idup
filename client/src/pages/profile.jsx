              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-[var(--blush)] focus:border-[var(--blush)] sm:text-sm pr-10"
                    required
                  />
                  <button
                    type="button"
