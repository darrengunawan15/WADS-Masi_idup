...
class Footer extends Component {
    scrollToSection = (sectionId) => {
        ...
        if (element) {
            ...
            const offset = sectionId === 'discover' ? 100 : navbarHeight;
                ...
                {/* <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between gap-12 bg-white bg-opacity-80 border-4 border-white rounded-lg p-6 shadow-xl"> */}
                    ...
                    <div className="md:w-1/2">
                        <div className="flex items-center space-x-3 mb-4">
                            <img src={logo} alt="Kitchen Serve Logo" className="h-16 w-auto" />
                            <span className="text-xl font-bold text-[var(--blush)]">Kitchen Serve+</span>
                        </div>
                        <p className="text-sm mb-6 text-black">Savor the Comfort, Taste the Love</p>
                        <div className="flex space-x-4">
                            <a
                                href="https://api.whatsapp.com/send?phone=628881762606"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded shadow flex items-center space-x-2"
                            >
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="bg-pink-600 hover:bg-pink-700 text-white px-4 py-2 rounded shadow flex items-center space-x-2"
                            >
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <ul className="space-y-2 text-sm text-black">
                                <li>
                                    <button 
                                        ...
                                        className="hover:text-[var(--hotpink)] transition-colors cursor-pointer"
                                    >
                                        About Us
                                    </button>
                                </li>
                                <li>
                                    <button 
                                        onClick={() => this.scrollToSection('products')}
                                        className="hover:text-[var(--hotpink)] transition-colors cursor-pointer"
                                    >
                                        Our Products
                                    </button>
                                ...
                                <li>
                                    <button 
                                        onClick={() => this.scrollToSection('faqs')}
                                        className="hover:text-[var(--hotpink)] transition-colors cursor-pointer"
                                    >
                                        FAQs
                                    </button>
                                ...
                                <li>
                                    <button 
                                        onClick={() => this.scrollToSection('discover')}
                                        className="hover:text-[var(--hotpink)] transition-colors cursor-pointer"
                                    >
                                        Discover Us
                                    </button>
